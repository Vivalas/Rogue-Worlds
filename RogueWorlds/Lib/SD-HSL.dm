...
proc/inverse_rgb(hex)
	var
		R = text2num(sd_base2dec(copytext(hex,2,4),16))
		G = text2num(sd_base2dec(copytext(hex,4,6),16))
		B = text2num(sd_base2dec(copytext(hex,6),16))
	return list(R,G,B)
